...
public class UpdateConfig implements Parcelable {
     ...
     * 是否支持通过删除通知栏来取消下载
     */
    private boolean isSupportNotifyCancelDownload = false;
    ...
    public boolean isSupportNotifyCancelDownload() {
        return isSupportNotifyCancelDownload;
    }
     ...
     * @return
     * @deprecated 此方法已标记为废弃，后续可能会删除；请使用 {@link #setSupportNotifyCancelDownload(boolean)}
     */
    @Deprecated
    public void setCancelDownload(boolean cancelDownload) {
        setSupportNotifyCancelDownload(cancelDownload);
    }

    /**
     * 是否支持通过删除通知栏来取消下载（默认为：false）
     *
     * @param supportNotifyCancelDownload
     */
    public void setSupportNotifyCancelDownload(boolean supportNotifyCancelDownload) {
        isSupportNotifyCancelDownload = supportNotifyCancelDownload;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(this.isSupportNotifyCancelDownload ? (byte) 1 : (byte) 0);
    ...
    protected UpdateConfig(Parcel in) {
        ...
        this.isSupportNotifyCancelDownload = in.readByte() != 0;
        this.apkMD5 = in.readString();
        this.apkSize = in.readLong();
        this.patchUrl = in.readString();
        this.patchSize = in.readLong();
        this.patchMD5 = in.readString();
    }
